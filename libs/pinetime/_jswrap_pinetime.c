...
NO_INLINE void jswrap_pinetime_setTheme() {
  graphicsTheme.fg = GRAPHICS_COL_RGB_TO_16(255, 255, 255);
  graphicsTheme.bg = GRAPHICS_COL_RGB_TO_16(255, 0, 0);
  graphicsTheme.fg2 = GRAPHICS_COL_RGB_TO_16(255, 255, 255);
  graphicsTheme.bg2 = GRAPHICS_COL_RGB_TO_16(0, 0, 255);
...
void peripheralPollHandler() {
  ...
  bool isCharging = jswrap_pinetime_isCharging();
...
void jswrap_pinetime_pwrBacklight(bool on) {
  jshPinOutput(LCD_BL, on);
}

static void jswrap_pinetime_setLCDPowerController(bool isOn) {
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setBacklight",
    "generate" : "jswrap_pinetime_setLCDPowerBacklight",
    "params" : [
...
void jswrap_pinetime_setLCDPowerBacklight(bool isOn) {
  ...
  jswrap_pinetime_pwrBacklight(isOn && (lcdBrightness>0));
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setLCDPower",
    "generate" : "jswrap_pinetime_setLCDPower",
    "params" : [
...
void jswrap_pinetime_setLCDPower(bool isOn) {
  ...
  jswrap_pinetime_setLCDPowerController(isOn);
  jswrap_pinetime_setLCDPowerBacklight(isOn);
...
/*JSON{
    ...
    "generate" : "jswrap_pinetime_setLCDBrightness",
    "params" : [
...
void jswrap_pinetime_setLCDBrightness(JsVarFloat v) {
  ...
  if (pinetimeFlags & JSPF_LCD_ON)  // need to re-run to adjust brightness
    jswrap_pinetime_setLCDPowerBacklight(1);
}
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setOptions",
    "generate" : "jswrap_pinetime_setOptions",
    "params" : [
      ["options","JsVar",""]
    ],
    "ifdef" : "PINETIME",
...
*/
JsVar * _jswrap_pinetime_setOptions(JsVar *options, bool createObject) {
...
void jswrap_pinetime_setOptions(JsVar *options) {
  _jswrap_pinetime_setOptions(options, false);
}
/*JSON{
    "type" : "staticmethod",
    "class" : "Pinetime",
    "name" : "getOptions",
    "generate" : "jswrap_pinetime_getOptions",
...
JsVar *jswrap_pinetime_getOptions() {
  return _jswrap_pinetime_setOptions(NULL, true);
}
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "isLCDOn",
    "generate" : "jswrap_pinetime_isLCDOn",
...
NO_INLINE void jswrap_pinetime_init() {
  ...
  if (!firstRun) {
    ...
    if (drawInfo) {
      ...
      jsvUnLock(addr);
      jswrap_graphics_drawCString(&graphicsInternal, 10, 20, "Espruino " JS_VERSION);
      jswrap_graphics_drawCString(&graphicsInternal, 10, 50, addrStr);    
      jswrap_graphics_drawCString(&graphicsInternal, 64, 190, "PineTime");
      jswrap_graphics_drawCString(&graphicsInternal, 10, 220, "2023 - joaquim.org");
    }
    graphicsInternalFlip();
    graphicsStructResetState(&graphicsInternal);
  }  
...
bool jswrap_pinetime_idle() {
  ...
  if (pinetimeTasks != JSPT_NONE) {
    if (pinetimeTasks & JSPT_LCD_OFF) jswrap_pinetime_setLCDPower(0);
    if (pinetimeTasks & JSPT_LCD_ON) jswrap_pinetime_setLCDPower(1);
    if (pinetimeTasks & JSPT_LCD_BL_OFF) jswrap_pinetime_setLCDPowerBacklight(0);
    if (pinetimeTasks & JSPT_LCD_BL_ON) jswrap_pinetime_setLCDPowerBacklight(1);
    if (pinetimeTasks & JSPT_LOCK) jswrap_pinetime_setLocked(1);
    if (pinetimeTasks & JSPT_UNLOCK) jswrap_pinetime_setLocked(0);
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "appRect",
    "generate" : "jswrap_pinetime_appRect",
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "isLocked",
    "generate" : "jswrap_pinetime_isLocked",
...
static NO_INLINE void _jswrap_pinetime_setVibration() {
  int beep = 0;
...
*/
void jswrap_pinetime_beep_callback() {
  beepFreq = 0;
  if (pinetimeFlags & JSPF_BEEP_VIBRATE) {
    _jswrap_pinetime_setVibration();
  }
  jshHadEvent();
}
...
JsVar *jswrap_pinetime_beep(int time, int freq) {
  ...
  if (promiseBeep) {
    JsVar *fn = jsvNewNativeFunction((void (*)(void))jswrap_pinetime_beep, JSWAT_JSVAR|(JSWAT_INT32<<JSWAT_BITS)|(JSWAT_INT32<<(JSWAT_BITS*2)));
    JsVar *v;
  ...
  jstExecuteFn(jswrap_pinetime_beep_callback, NULL, jshGetTimeFromMilliseconds(time), 0, NULL);
...
*/
void jswrap_pinetime_buzz_callback() {
  buzzAmt = 0;
  _jswrap_pinetime_setVibration();
  jshHadEvent();
}
...
JsVar *jswrap_pinetime_buzz(int time, JsVarFloat amt) {
  ...
  if (time>5000) time=5000;
  if (promiseBuzz) {
    JsVar *fn = jsvNewNativeFunction((void (*)(void))jswrap_pinetime_buzz, JSWAT_JSVAR|(JSWAT_INT32<<JSWAT_BITS)|(JSWAT_JSVARFLOAT<<(JSWAT_BITS*2)));
    JsVar *v;
    v=jsvNewFromInteger(time);jsvAddFunctionParameter(fn, 0, v);jsvUnLock(v); // bind param 1
  ...
  if (jstExecuteFn(jswrap_pinetime_buzz_callback, NULL, jshGetTimeFromMilliseconds(time), 0, NULL)) {
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setLocked",
    "generate" : "jswrap_pinetime_setLocked",
    "params" : [
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setLCDOffset",
    "generate" : "jswrap_pinetime_setLCDOffset",
    "params" : [
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setHRMPower",
    "generate" : "jswrap_pinetime_setHRMPower",
    "params" : [
...
/*JSON{
    ...
    "class" : "E",
    "name" : "showMessage",
    "generate_js" : "libs/js/pinetime/E_showMessage.min.js",
    "params" : [
      ["message","JsVar","A message to display. Can include newlines"],
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "drawWidgets",
    "generate_js" : "libs/js/pinetime/Pinetime_drawWidgets.min.js",
    "ifdef" : "PINETIME"
}
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "setUI",
    "generate_js" : "libs/js/pinetime/Pinetime_setUI.min.js",
    "params" : [
...
/*JSON{
    ...
    "class" : "Pinetime",
    "name" : "showLauncher",
    "generate_js" : "libs/js/pinetime/Pinetime_showLauncher.min.js",
    "ifdef" : "PINETIME"
}
...
/*JSON{
    ...
    "class" : "E",
    "name" : "showScroller",
    "generate_js" : "libs/js/pinetime/E_showScroller.min.js",
    "params" : [
...
/*JSON{
    ...
    "class" : "E",
    "name" : "showPrompt",
    "generate_js" : "libs/js/pinetime/E_showPrompt.min.js",
    "params" : [
      ["message","JsVar","A message to display. Can include newlines"],
...
/*JSON{
    ...
    "class" : "E",
    "name" : "showMenu",
    "generate_js" : "libs/js/pinetime/E_showMenu.min.js",
    "params" : [
